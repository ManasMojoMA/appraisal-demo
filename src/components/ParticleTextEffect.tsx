...
export function ParticleTextEffect({
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    const newColor =
      BRAND_COLORS[wordIndexRef.current % BRAND_COLORS.length];
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-3xl border border-white/10 bg-[#08111F] shadow-2xl ${className}`}
    >
